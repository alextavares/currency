    ...
    <main className="min-h-screen text-slate-900 dark:text-white">
      ...
      <div className="container mx-auto max-w-4xl p-4 sm:p-6">
        ...
        <div className="space-y-4">
          <FaqItem q="What does the 0–100 score mean?">
            The score is a normalized strength ranking for each currency within the selected timeframe.
            Higher values mean the currency has been stronger relative to the others in the basket.
          </FaqItem>

          <FaqItem q="Which currencies are included?">
            The meter focuses on the 8 major currencies: USD, EUR, GBP, JPY, CHF, CAD, AUD and NZD.
          </FaqItem>

          <FaqItem q="How often does it update?">
            It updates live on the dashboard. If the market is quiet (no ticks), the UI can still refresh
            with the latest computed snapshot.
          </FaqItem>

          <FaqItem q="How should I use multiple timeframes?">
            Use higher timeframes (4h/12h/1W) to identify the broader bias, and lower timeframes (5m/15m/30m)
            to time entries. Many traders look for strong-vs-weak pairs that align across timeframes.
          </FaqItem>

          <FaqItem q="Is this financial advice or a trade signal?">
            No. This is an analysis tool. Always validate with your own strategy, risk management, and
            market context (news, sessions, liquidity).
          </FaqItem>
